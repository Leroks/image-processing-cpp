...
std::vector<std::pair<int, int>> EdgeDetector::detectEdges(const ImageMatrix& input_image) {
    // Initialize matrix for the Sobel operators
    ...
    // Convolve the input image with Sobel operators
    ...
    // Add all pixels with magnitude above the threshold to the list of edge pixels
